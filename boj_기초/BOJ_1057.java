 ...
 * 그러고 난 후에 서로 인접한 번호끼리 스타를 한다. 이긴 사람은 다음 라운드에 진출하고, 진 사람은 그 라운드에서 떨어진다. 만약 그 라운드의 참가자가 홀수명이라면, 
 * 마지막 번호를 가진 참가자는 다음 라운드로 자동 진출한다. 다음 라운드에선 다시 참가자의 번호를 1번부터 매긴다. 
 * 이 때, 번호를 매기는 순서는 처음 번호의 순서를 유지하면서 1번부터 매긴다. 이 말은 1번과 2번이 스타를 해서 1번이 진출하고,
...
public class BOJ_1057 {
	...
	public static int N;
	public static int jimin;
	public static int hansoo;
	public static int round;

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		//hint 어떻게 올라가는지를 잘파악해야해
